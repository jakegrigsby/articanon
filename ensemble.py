...
m1 = build_static_model('14')(x)
m2 = build_static_model('15')(x)
m3 = build_static_model('16')(x)
m4 = build_static_model('17')(x)
m5 = build_static_model('18')(x)
m6 = build_static_model('19')(x)
concat = Concatenate(axis=1)([m1,m2,m3,m4,m5,m6])
dense = Dense(264)(concat)
dense2 = Dense(128)(dense)
y = Dense(44, activation='softmax')(dense2)
model = Model(inputs=x, outputs=y)
model.compile(optimizer='rmsprop', loss='categorical_crossentropy', metrics=[categorical_accuracy, 'acc'])
...
if __name__ =="__main__":
    ...
    history = model.fit(x_seqs, y_chars, batch_size=128, epochs=50, callbacks=callbacks, validation_split=.4)
